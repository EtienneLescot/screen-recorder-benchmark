...
export function renderSite(result, { submissions, generatedAt, roster = [] }) {
	...
	// A cell says whether the tool holds a slot on that platform, which is not the same as
	// whether it runs there: the roster is capped at the size of the segment, so a product can
	// ship on a platform and still sit outside its table.
	const CELL = {
		"✓": '<span title="roster member">✓</span>',
		"✓?": '<span title="claimed but unverified — not measured until confirmed">✓?</span>',
		...
		surplus:
			'<span class="muted" title="ships here, but outside this platform&apos;s roster">—</span>',
	};
