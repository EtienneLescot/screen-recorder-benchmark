...
import { systemAudioArgs, writeFocuseeProject } from "./focuseeProject.mjs";
...
describe("writeFocuseeProject", () => {
	...
	it("stages the sidecar audio in stereo — mono is read as stereo pairs (half duration out)", () => {
		const args = systemAudioArgs("screen.mp4", "systemaudio-0.m4a");
